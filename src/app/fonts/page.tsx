    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '14px', opacity: 0.9 }}>可用字体</div>
        </div>
        <div
          style={{
        ...
        >
          ...
          <div style={{ fontSize: '14px', opacity: 0.9 }}>字体别名</div>
        </div>
        <div
          style={{
        ...
        >
          ...
          <div style={{ fontSize: '14px', opacity: 0.9 }}>字体格式</div>
        </div>
      </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  格式: {font.format.toUpperCase()} | 字重: {font.weight} |
                  样式: {font.style}
                </div>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  backgroundColor:
                    selectedFont === font.name ? '#2ecc71' : '#3498db',
                  color: 'white',
                  border: 'none',
                  borderRadius: '4px',
                  cursor: 'pointer',
